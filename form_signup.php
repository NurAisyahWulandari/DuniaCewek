...
<!-- TAG FORM -->
	...
	<div class="login-table">
		<h1 style="color: #392467">Sign Up</h1>
		<form action="proses_signup.php" method="post">
			<table>
				...
				<tr>
					<td></td>
					<td><input type="submit" name="submit" value="Sign Up" style="background-color: #5D3587; color: #fff"></td>
				</tr>
				<tr>
					<td colspan="2">
						<?php
							...
							if (isset($_SESSION['first_name'])){
								...
								$msg = "Sudah punya akun? <a href='form_signin.html' style='color: #A367B1;'>Masuk disini!</a>";
							}
						 ?>
						<center><br>
							<?php echo $msg; ?>
